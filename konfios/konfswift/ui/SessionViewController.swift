...
class SessionViewController : UIViewController, SessionDetailsView {
    ...
    let playbackService = BCOVPlaybackService(accountId: CommonKt.bcAccId, policyKey: CommonKt.bcPolicyKey)
    ...
    func requestContentFromPlaybackService() {
        playbackService?.findVideo(withVideoID: CommonKt.bcVideoId, parameters: nil) { (video: BCOVVideo?, jsonResponse: [AnyHashable: Any]?, error: Error?) -> Void in
